...
public class CategoryDao implements CategoryDaoInterface
{
	...
	public boolean addCache(CategoryItem item)
	{
		...
		try
		{
			...
			id = database.insert(SQLHelper.getTableName(), null, values);
	...
	public boolean deleteCache(String whereClause, String[] whereArgs)
	{
		...
		{
			database = helper.getWritableDatabase();
			id = database.delete(SQLHelper.getTableName(), whereClause,
					whereArgs);
			...
			String[] whereArgs)
	{
		...
		{
			database = helper.getWritableDatabase();
			id = database.update(SQLHelper.getTableName(), values, whereClause,
					whereArgs);
			flag = (id > 0 ? true : false);
		} catch (Exception e)
		{
			...
			String[] selectionArgs)
	{
		...
		try
		{
			...
			cursor = database.query(true, SQLHelper.getTableName(), null,
			...
			String[] selectionArgs)
	{
		...
		{
			database = helper.getReadableDatabase();
			cursor = database.query(false, SQLHelper.getTableName(), null,
					selection, selectionArgs, null, null, null, null);
	...
	{
		String sql = "DELETE FROM " + SQLHelper.getTableName() + ";";
